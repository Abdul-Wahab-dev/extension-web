...
const Faqs = () => {
  ...
  const faqs = [
...

    {
      ...
      answer:
        "Flexisaves offers a free version with essential features for saving and managing web content. In the free version, you can save up to 60 pieces of content, 30 notes, and create up to 10 custom collections. For extended storage options, more collections, premium support, and additional sharing capabilities",
    },
  ];
